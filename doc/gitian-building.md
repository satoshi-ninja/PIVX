...
```bash
    ...
    From https://github.com/PIVX-Project/PIVX/
...
For example:
```bash
URL=https://github.com/Mrs-X/PIVX.git
...
[pivx/gitian.sigs](https://github.com/PIVX-Project/gitian.sigs/) repository, or if that's not possible to create a pull
request.
